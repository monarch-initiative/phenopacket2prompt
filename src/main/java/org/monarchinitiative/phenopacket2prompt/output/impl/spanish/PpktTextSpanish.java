...
public class PpktTextSpanish implements PhenopacketTextGenerator {
    ...
    public String LLM_PROMPT_HEADER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/spanish_header.txt"));
        } catch (IOException e) {
            return "Header not found for spanish.";
        }
    }
    ...
    public String LLM_PROMPT_FOOTER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/spanish_footer.txt"));
        } catch (IOException e) {
            return "Header not found for spanish.";
        }
    }
