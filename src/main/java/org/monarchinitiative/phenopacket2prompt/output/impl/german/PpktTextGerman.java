...
public class PpktTextGerman implements PhenopacketTextGenerator {
    ...
    public String LLM_PROMPT_HEADER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/german_header.txt"));
        } catch (IOException e) {
            return "Header not found for german.";
        }
    }
    ...
    public String LLM_PROMPT_FOOTER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/german_footer.txt"));
        } catch (IOException e) {
            return "Header not found for german.";
        }
    }
