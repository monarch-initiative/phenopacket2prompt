...
public class PpktTextChinese implements PhenopacketTextGenerator {
    ...
    public String LLM_PROMPT_HEADER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/chinese_header.txt"));
        } catch (IOException e) {
            return "Header not found for chinese.";
        }
    }
    ...
    public String LLM_PROMPT_FOOTER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/chinese_footer.txt"));
        } catch (IOException e) {
            return "Header not found for chinese.";
        }
    }
