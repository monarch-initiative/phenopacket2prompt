...
public class PpktTextDutch implements PhenopacketTextGenerator {
    ...
    public String LLM_PROMPT_HEADER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/dutch_header.txt"));
        } catch (IOException e) {
            return "Header not found for dutch.";
        }
    }
    ...
    public String LLM_PROMPT_FOOTER() {
        try {
            return Files.readString(Path.of("src/main/resources/prompts/headers/dutch_footer.txt"));
        } catch (IOException e) {
            return "Header not found for dutch.";
        }
    }
